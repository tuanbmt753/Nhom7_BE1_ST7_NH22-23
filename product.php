													...
													if(isset($_SESSION['cart'][$id2])){
														...
														<tr>													
															<div class="product-widget">
																...
																<a href="del2.php?id=<?php echo $id2; ?>"><button class="delete"><i class="fa fa-close"></i></button></a>
															</div>														
												<?php	
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							...
							<?php
								...
								$dem = 0;
								$getProductProtypesByTypeID = $products->getProductProtypesByTypeID($type_id,0,4);
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<?php
								if(isset($_SESSION['product'])){						
									$id = $_SESSION['product'];
									$getProductProtypesByTypeID = $products->getProductProtypesByID($id,0,1);
									foreach ($getProductProtypesByTypeID  as $key => $value) {
							...
							<div>
								<h3 class="product-price"><?php echo number_format( $value['price']);?> VND <del class="product-old-price">990.00 VND</del></h3>
							...
							<div class="add-to-cart">
								...
								<a href="addcart2.php?id2=<?php echo $value['id']; ?>"><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
							</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					if($_SESSION['product']){						
						$id = $_SESSION['product'];
						$dem = 0;
						$getProductProtypesByTypeID = $products->getProductProtypesByTypeID($type_id,0,5);
							foreach ($getProductProtypesByTypeID  as $key => $value) { 
								if($value['id'] != $id){?>
