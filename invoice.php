...
<html lang="en">
    ...
    <div class="container">
		...
		<table border="1" cellspacing="0" cellpadding="5">
			...
			<?php 
				$getAllInvoices =  $invoice->getAllInvoice(); 
				foreach ($getAllInvoices as $key => $value) {	
			?>
					<tr>
						...
						<td style="color: brown;"><?php echo number_format( $value['sum']); ?>VND</td>
						<td><a href="invoice-delete.php?id=<?php echo $value['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
