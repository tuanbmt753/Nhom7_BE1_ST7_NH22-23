													...
													if(isset($_SESSION['cart'][$id2])){
														...
														<tr>													
															<div class="product-widget">
																...
																<a href="del.php?id=<?php echo $id2; ?>"><button class="delete"><i class="fa fa-close"></i></button></a>
															</div>														
												<?php	
        ...
        <?php 
			...
			$id2 = $value['id'];
			 if(isset($_SESSION['cart'][$id2])){
                ...
                <tr>
                    <td><?php echo $id2;?></td>
					<td ><img src="./img/<?php echo $value['image']; ?>" alt="" style="width: 50px;"></td>
                    <td style="font-weight: bold;"><?php echo $value['name']; ?></td>
                    <td><?php echo $_SESSION['cart'][$id2]; ?></td>
                    <td style="color: brown;">$<?php echo number_format( $value['price']); ?></td>
                    <td><a href="del.php?id=<?php echo $id2; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
