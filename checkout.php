										...
										?>
												<tr>													
													...
													<div class="product-body">
														...
														<h4 class="product-price"><span class="qty"><?php echo $_SESSION['cart'][$id2]; ?>x</span><?php echo  number_format( $value['price']); ?> VND</h4>
													</div>
														<a href="del4.php?id=<?php echo $id2; ?>"><button class="delete"><i class="fa fa-close"></i></button></a>
										</div>														
										<?php	
					...
					<div class="col-md-5 order-details">
						...
						<div class="order-summary">
							...
							<div class="order-products">
								...
								?>
								<div class="order-col">
									<div><?php echo $_SESSION['cart'][$id2]; ?>x <?php echo $value['name']; ?></div>
